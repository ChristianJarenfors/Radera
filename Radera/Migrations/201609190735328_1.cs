    ...
    public partial class _1 : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Users", t => t.AuctionOwner_UserID)
                ...
                c => new
                    {
                        ...
                        ThisAuction_AuctionID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.BidID)
                .ForeignKey("dbo.Users", t => t.BidOwner_UserID)
                .ForeignKey("dbo.Auctions", t => t.ThisAuction_AuctionID, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CommentAuction_AuctionID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.CommentID)
                .ForeignKey("dbo.Users", t => t.CommentOwner_UserID)
                .ForeignKey("dbo.Auctions", t => t.CommentAuction_AuctionID, cascadeDelete: true)
